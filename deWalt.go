...
func main(){
    ...
    nil//think this really should start with a byte reader to get a dictioary and store the req info frm mainMachi
        //need to read(or call the parser ffrom keyStone) and look for the port#mite need an arry 
    //
}
